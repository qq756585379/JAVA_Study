                    ...
                    <tr>
                        <td><img src="images/ad/page_ad.jpg" width="666" height="89"/>
                            <table width="100%" border="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <img src="images/main/buy1.gif" width="635" height="38"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        <c:forEach items="${cart }" var="entry" varStatus="vs">
                                            <table width="100%" border="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="10%">
                                                        <a href="${pageContext.request.contextPath}/servlet/changeNumServlet?id=${entry.key.id}&num=0"
                                        ...
                                        <div style="text-align:right; margin-top:10px">
                                            ...
                                            <a href="${pageContext.request.contextPath}/order.jsp">
                                                <img src="images/main/gwc_buy.gif" border="0"/>
                                            </a>
                                        </div>
                                    </td>
                                </tr>
