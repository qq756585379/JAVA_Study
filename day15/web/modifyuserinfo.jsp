        ...
        <tr>
            ...
            <td>
                <div style="text-align:right; margin:5px 10px 5px 0">
                    ...
                    <a href="MyAccount.jsp">&nbsp;我的帐户</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;用户信息修改
                </div>
                        ...
                        <td>
                            <form action="${pageContext.request.contextPath }/modifyUserServlet" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">&nbsp;&nbsp;
                                            <input type="radio" name="gender"
                                                   value="男" ${u.gender== "男"? "checked='checked' ":"" } />
                                            男 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="radio" name="gender"
                                                   value="女" ${u.gender== "女"? "checked='checked' ":"" } /> 女
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <p style="text-align:center">
                                    <input type="image" src="images/main/botton_gif_025.gif" border="0">
                                </p>
